...
class Compliance{
     ...
     */    
    protected $compliancename=null;
    
    /**
     * @ORM\ManyToMany(targetEntity="Asset", mappedBy="compliances")
     */    
    protected $assets;
    ...
    public function getCompliancename() {
    ...
    public function setCompliancename($compliancename) {
